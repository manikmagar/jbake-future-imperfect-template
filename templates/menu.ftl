        ...
        <ul>
        	<#list config.site_menus_main as menuItem1>
        		<#if (config.site_menus_main_showTagsDropdown?boolean)?? == true && menuItem1 == 'tags'>
        			<li>
	                    <a href="<#if (config['site_menus_main_' + menuItem1 + '_url']?has_content)> ${content.rootpath}${config['site_menus_main_' + menuItem1 + '_url']}<#else> ${config.site_host}</#if>">
        ...
        <section>
            <ul class="links">
                <#list config.site_menus_main as menuItem>
        		 <li>
                    <a href="<#if (config['site_menus_main_' + menuItem + '_url']?has_content)> ${content.rootpath}${config['site_menus_main_' + menuItem + '_url']}<#else> ${config.site_host}</#if>">
